...
public class Testes {
		...
		public void TesteRecuperaEmpregadoSalario() {
			...
			Empregado p = ListaDeFuncionario.recuperaEmpregado(0);
			double resultado = p.getSalarioBase();
		...
		public void TesteAdcionaVencimento() {
			...
			boolean resultado = v.adicionaNaLista(new GratDesempenho(2500, "10/06"));
			assertTrue(resultado);
		}
		...
		public void TesteRemoveVencimento() {
			...
			w.adicionaNaLista(new GratDesempenho(2500, "10/06"));
			w.removeDaLista(0);
		...
		public void TesteModificaVencimento() {
			...
			Vencimento w = new Vencimento();
			w.adicionaNaLista(new GratDesempenho(2500, "15/09"));
